...
public class ShareUser implements Serializable {
    ...
    public ShareUser userEmail(String userEmail) {
    ...
    public ShareUser userRole(UserRole userRole) {
    ...
    public ShareUser userPhone(String userPhone) {
    ...
    public ShareUser userStatus(UserStatus userStatus) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShareUser)) {
            return false;
        }
        return id != null && id.equals(((ShareUser) o).id);
    }
