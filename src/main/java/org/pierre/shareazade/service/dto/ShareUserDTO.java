...
/**
 * A DTO for the {@link org.pierre.shareazade.domain.ShareUser} entity.
 */
...
public class ShareUserDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShareUserDTO)) {
            return false;
        }

        ShareUserDTO shareUserDTO = (ShareUserDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, shareUserDTO.id);
    }
