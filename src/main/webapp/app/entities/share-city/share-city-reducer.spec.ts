...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHARECITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHARECITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHARECITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHARECITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHARECITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHARECITY actions', async () => {
      const expectedActions = [
        {
