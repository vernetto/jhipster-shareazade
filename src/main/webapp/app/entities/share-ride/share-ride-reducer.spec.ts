...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHARERIDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHARERIDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHARERIDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHARERIDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHARERIDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHARERIDE actions', async () => {
      const expectedActions = [
        {
