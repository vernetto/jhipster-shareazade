...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHAREUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHAREUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHAREUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHAREUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHAREUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHAREUSER actions', async () => {
      const expectedActions = [
        {
